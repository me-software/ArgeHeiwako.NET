...
namespace ArgeHeiwako.Data.Common
{
    ...
    public sealed class KundenNummer
    {
        ...
        private readonly long kundennummer;
        ...
        {
            return kundennummer < 0 ? 
                string.Format("{0:000000000}", kundennummer) : 
                string.Format("{0:0000000000}", kundennummer);
        }
